...
import { Text, View, Image, ScrollView, ImageBackground, Pressable, AppState } from 'react-native';
...
const Profile = () => {
  ...
  return (
    <>
      ...
      { !isLoggedIn && <Login handleClose={handleClose} cancelBtnVisibility={false} />}

      <ScrollView showsVerticalScrollIndicator={false}>
        <ImageBackground source={TestPicture} style={profileStyle.image} >
          <View style={{ alignSelf: 'center' }}>
            <View style={profileStyle.profileImage}>
              <Image source={{uri: user.user_picture}} style={profileStyle.image} resizeMode="cover"></Image>
            </View>
          </View>
        </ImageBackground>
